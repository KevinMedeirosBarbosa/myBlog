...
export default function SideMenu({ children }: any) {
  const name = "Kevin Medeiros";
  const email = "kevinbarbosa@gmail.com";

  return (
    <aside className="h-screen">
      <nav className="h-full flex flex-col bg-white border-stone-300 border-[1px]  shadow-2xl">
              ...
              <a
                ...
                className={classNames(
                  item.current
                    ...
                    : "text-stone-700 hover:bg-blue-500 duration-300 hover:text-white",
        ...
        <div className="border-t flex p-3">
          <div className="flex py-2 px-3 rounded-md bg-blue-500/80 text-bold text-white shadow-md ">
            {name
              .split(" ")
              .slice(0, 2)
              .map((word) => word[0])
